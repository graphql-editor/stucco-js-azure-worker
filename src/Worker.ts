...
import { CreateGrpcEventStream } from 'azure-functions-nodejs-worker/dist/src/GrpcService';
import { systemLog, systemError } from 'azure-functions-nodejs-worker/dist/src/utils/Logger';
