...
import { LogCallback, ResultCallback } from 'azure-functions-nodejs-worker/dist/src//Context';
import { IEventStream } from 'azure-functions-nodejs-worker/dist/src//GrpcService';
import { toTypedData } from 'azure-functions-nodejs-worker/dist/src//converters';
import { augmentTriggerMetadata } from 'azure-functions-nodejs-worker/dist/src//augmenters';
import { systemError, systemWarn } from 'azure-functions-nodejs-worker/dist/src//utils/Logger';
